...
urlpatterns = [
  ...
  path('unenrollSession',Fstudent.unenrollSession,name='unenrollSession'),
  ...
  path('removeSession',FtutorOrg.removeSession,name='removeSession'),
  path('insertResource',FtutorOrg.insertResource,name='insertResource'),
  path('addClassToSession',FtutorOrg.addClasstoSession,name='addClassToSession'),
  path('addTutorToSession',FtutorOrg.addTutorToSession,name='addTutorToSession'),
  ...
  path('editProfile',Fuser.editProfile,name="editProfile"),
  ...
  path('registerOrgtut',Ftutor.registerOrgtut,name='registerOrgtut'),
   path('unregisterFromOrg',Ftutor.unregisterFromOrg,name='unregisterFromOrg'),
